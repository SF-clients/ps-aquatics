 ...
 *   *
 *    * It's preferable to configure the script using this file istead of
 *    directly.
 *     *
 ...
 *      * @var string
 *       */
define('SECRET_ACCESS_TOKEN', 'lkjasd9f12nasdlfkj219dsafnlkjasdf912nsdaflkjsdaf9dnxc9djsadflkjasdf');

/**
 *  * The address of the remote Git repository that contains the code that's
 *  being
 *   * deployed.
 ...
 *      * @var string
 *       */
define('REMOTE_REPOSITORY', 'git@github.com:SF-clients/ps-aquatics.git');
 ...
 *      */
define('TARGET_DIR', '/home/petsmart/public/');
 ...
 *   * Normally, these are the directories containing files that are not part
 *   of
 ...
 *   * already exists, script assumes that it contains an already cloned copy
 *   of the
